...
public class BoardValidator {
    ...
    public boolean validateRow(int row, int column, int value) {
    ...
    public boolean validateColumn(int row, int column, int value) {
        for (int  i = Board.MIN_INDEX; i <= Board.MAX_INDEX; i++) {
    ...
    public boolean validateSector(int row, int column, int value) {
    ...
    public static void checkCoordinates(int row, int column) throws InvalidCoordinatesException {
        if (column < Board.MIN_INDEX || column > Board.MAX_INDEX) {
            throw new InvalidCoordinatesException("Invalid column coordinate: " + column);
        }
        if (row < Board.MIN_INDEX || row > Board.MAX_INDEX) {
            throw new InvalidCoordinatesException("Invalid row coordinate: " + row);
        }
    }
